...
# import  as res
from models.net.resnet import ResNet, ResNet_Video_nonlocal, ResNet_Video_nonlocal_stripe, ResNet_Video_nonlocal_hr, \
    ResNet_Video_nonlocal_stripe_hr
...
class CNN(nn.Module):
    def __init__(self,out_dim=2048,model_type='resnet50_NL_stripe_hr',num_class=710,non_layers=[0, 2, 3, 0],stripes=[16,16,16,16], temporal = 'Done',stride=1):
